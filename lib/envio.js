...
import { querPerfurado, querParachoque } from './scoring.js';
...
export function envioPadrao(pedido) {
  ...
  // Os adesivos não vêm no kit: entram só para quem respondeu que quer, um de cada.
  if (querPerfurado(pedido)) saida.adesivo_carro = 1;
  if (querParachoque(pedido)) saida.adesivo_parachoque = 1;
